...
# Gabor
def Gabor_filter(K_size=111, Sigma=10.0, Gamma=1.2, Lambda=10, Psi=0, angle=0):
    # get half size
    d = K_size // 2
...
def Gabor_filtering(gray, K_size=111, Sigma=10.0, Gamma=1.2, Lambda=10, Psi=0, angle=0):
    # get shape
    H, W = gray.shape
